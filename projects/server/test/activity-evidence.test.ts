...
const cases: [string, string, unknown, boolean][] = [
  ...
  ["constructor kind excluded", "constructor", {}, false],
  ["prototype kind excluded", "__proto__", {}, false],
  ["toString kind excluded", "toString", {}, false],
...
describe("activity evidence SQL", () => {
  ...
  it.each([
    ...
    ["constructor kind", "constructor", null, false],
    ["prototype kind", "__proto__", null, false],
    ["toString kind", "toString", null, false],
    ["valid allowed payload", "opened", {}, false],
